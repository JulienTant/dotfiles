...
1. Enable allow-present-passphrase, and set pretty high cache ttls

#+begin_src sh
echo -e "allow-preset-passphrase\ndefault-cache-ttl 1209600\nmax-cache-ttl 1209600\nmax-cache-ttl-ssh 1209600" > ~/.gnupg/gpg-agent.conf
#+end_src

2. Get the keygrip of your gpg key

#+begin_src sh
gpg --with-keygrip -K
#+end_src

3. replace  XXXXXX bellow by your key grip
